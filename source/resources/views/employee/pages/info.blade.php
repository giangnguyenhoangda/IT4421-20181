											...
											<div class="timeline-container">
												...
												<div class="timeline-row">
													<div class="timeline-icon">
														<a href="#"><img src="{{ asset('uploads/placeholder.jpg') }}" alt=""></a>
													</div>
													...
													<div class="panel panel-flat timeline-content">
														...
														<div class="panel-body">
															<a href="#" class="display-block content-group">
																<img src="{{ asset('uploads/placeholder.jpg') }}" class="img-responsive content-group" alt="">
															</a>
															...
															<ul class="media-list chat-list content-group">
																...
																<li class="media reversed">
																	...
																	<div class="media-right">
																		<a href="{{ asset('uploads/placeholder.jpg') }}">
																			<img src="{{ asset('uploads/placeholder.jpg') }}" class="img-circle" alt="">
																		</a>
																	</div>
																</li>
								...
								<ul class="media-list media-list-linked pb-5">
									...
									<li class="media">
										<a href="#" class="media-link">
											<div class="media-left"><img src="{{ asset('uploads/placeholder.jpg') }}" class="img-circle" alt=""></div>
											<div class="media-body">
